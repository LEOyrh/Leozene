...
import '../controller/songScreen_controller.dart';
...
class SongScreen extends StatefulWidget {
  ...
  SongScreen(this.user, this.song);

  @override
  State<StatefulWidget> createState() {
    // state we need to pass these info as well
    return SongScreenState(user, song);
  }
}
...
class SongScreenState extends State<SongScreen> {
  ...
  SongScreenState(this.user, this.song) {
    // we pass the current state obj
    controller = SongScreenController(this);
    if (song == null) {
      // addButton
      songCopy = Song.empty();
    } else {
